...
$sql_ins=mysql_query("INSERT INTO teachers 
						VALUES(
							NULL,
							'$f_name',
							'$l_name' ,
...
$sql_update=mysql_query("UPDATE teachers SET
                        f_name='$f_name' ,
                        l_name='$l_name' ,
                        gender='$gender' ,
                        dob='$dob' ,
...
if($opr=="upd")
{
	$sql_upd=mysql_query("SELECT * FROM teachers WHERE teacher_id=$id");
...
<div class="panel panel-default">
  		<div class="panel-heading"><h1><span class="glyphicon glyphicon-user"></span> Teachers Update Form</h1></div>
			...
			<div>
				<p style="text-align:center;">Update the teacher's records into database.</p>
			</div>
...
<div class="panel panel-default">
  		<div class="panel-heading"><h1><span class="glyphicon glyphicon-user"></span> Teachers Entry Form</h1></div>
  			<div class="panel-body">
			<div>
				<p style="text-align:center;">Add new teacher's detail to record into database.</p>
			</div>
